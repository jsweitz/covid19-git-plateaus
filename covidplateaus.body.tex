...
one or more reported deaths. (Top) Selected national
level averages; (Bottom) US state level averages.
...
\caption{Schematic of a SEIR model with awareness-driven social distancing.
...
awareness of population-level severity suggests a generic outcome: first fatalities will grow
