...
We used principal component analysis (PCA) on the mobility data to obtain a univariate index of mobility. 
...
To draw phase planes, we further smoothed \cmt{JD: What? The index? The index and the incidence values?} using locally estimated scatterplot smoothing \cmt{JD: Explain briefly.}
