...
COVID-19 fatalities.  (A) Examples of locally estimated scatterplot smoothing (LOESS) of daily number of deaths for COVID-19 in four states, including
...
one or more reported deaths; US state level averages.
(B) Smoothed daily number of reported deaths centered around the first
fatality peak of the epidemic for 17 states. (C) Measured
symmetry coefficient and confidence intervals. Methods and Supplementary
Information contain detailed description of the LOESS smoothing in (A),
peak identification in (B), and symmetry coefficient estimator in (C).
...
Yet, for a disease
that is already the documented cause of more than XXXX deaths
...
data obtained from \textbf{sources X and Y}
...
Counter-clockwise shapes are not observed in any of the data sets we studied. 
...
\includegraphics[width=0.5\textwidth]{national_deaths_metric_phase_pca_grand.pdf}\\
\includegraphics[width=0.325\textwidth]{figseir_phase2_noname.pdf}
\includegraphics[width=0.325\textwidth]{figseir_phase2_statefix_noname.pdf}
\includegraphics[width=0.325\textwidth]{figseir_phase2_state_noname.pdf}
