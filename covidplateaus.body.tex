...
\begin{figure*}[t!]
\begin{center}
\includegraphics[width=0.8\textwidth]{figseir_baseplat_k1_noname.pdf}\\
\includegraphics[width=0.8\textwidth]{figseir_baseplat_k2_noname.pdf}\\
\includegraphics[width=0.8\textwidth]{figseir_baseplat_k4_noname.pdf}
