...
\jd{What is ``increasing'' and causing shoulders? Everything in the referenced figure has shoulders? Also, what is $a$?}
...
\jd{Whatever you're saying about non-linearity is not how we ``interpret this finding''. It's a side point. Spin this \P\ into two: one about what the curves have in common and the main point, and one that is a bit clearer about the effects of non-linearity.}
