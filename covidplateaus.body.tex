...
Next, the link between severity and behavior change is depends on reporting of disease outcomes.
...
Otherwise reductions in cases (and fatalities) will necessarily be attributed to exogeneous factors (e.g., an influential analysis of the impact of non-pharmaceutical interventions on Covid-19 in Europe highlighted the fact that such analysis does not account for changes in behavior~\citep{flaxman_2020}).
