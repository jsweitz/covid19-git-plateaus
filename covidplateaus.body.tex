...
Next, we extended this model to the case of COVID-19, including 
...
incidence fatality rate of $IFR=0.82\%$. Figure~\ref{fig.covid-plat}}
...
a lag), and so on.  We note that these oscillations could be amplified 
...
lag-driven oscillations. As a result, passing a `peak' need not imply
the rapid decline of risk. Instead, as cumulative data from outbreak epidemics have already
shown, the asymmetric post-peak dynamics of COVID-19 may be an emergent
