...
% figure is drawn
tmpfilename = 'figseir_Hlong_k2Dtot';
...
ylabel({'Cumulative Deaths';'given $N=10,000,000$'},'fontsize',20,'verticalalignment','bottom','interpreter','latex');
%title('(A) Awareness, $k=2$','fontsize',20,'interpreter','latex');
set(gca,'fontsize',20);
% loglog(,, '');
%
%
